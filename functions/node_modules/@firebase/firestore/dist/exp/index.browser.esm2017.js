...
class F {
    ...
    getToken() {
        ...
        this.getToken()) : e ? (C("string" == typeof e.accessToken), new k(e.accessToken, this.currentUser)) : null)) : Promise.resolve(null);
    }
    _() {
        this.forceRefresh = !0;
    }
 ...
 */ class Y extends J {
     ...
     */    static nt(...t) {
        ...
        const e = [];
        for (const n of t) {
            if (n.indexOf("//") >= 0) throw new O(x.INVALID_ARGUMENT, `Invalid segment (${n}). Paths must not contain // in them.`);
 ...
 */ class bn {
    ...
    static Fe(t, e) {
        const n = new Map;
        return n.set(t, vn.Le(t, e)), new bn(H.min(), n, Vn(), dn(), Rn());
    }
}
...
class xn {
     ...
     */    gn(t) {
        ...
        return this.hn = dn(), this.ln = On(), this._n = new ln(W), s;
    }
    /**
...
function jn(t, e) {
    const n = Qn(e);
    if (n.get(1) !== t.p.projectId) throw new O(x.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.p.projectId);
    if (n.get(3) !== t.p.database) throw new O(x.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.p.database);
    return new tt(Jn(n));
}
 ...
 */ (o);
        ...
        s.document;
        const i = jn(t, s.document), r = s.readTime ? Un(s.readTime) : H.min(), o = new Ot(i, r), c = s.removedTargetIds || [];
        n = new Sn([], c, o.key, o);
...
function ns(t, e) {
    const n = e.currentDocument ? function(t) {
        ...
        if ("setToServerValue" in e) C("REQUEST_TIME" === e.setToServerValue), n = new Se; else if ("appendMissingElements" in e) {
            ...
            n = new Ne(t);
        } else "increment" in e ? n = new Oe(t, e.increment) : D();
 ...
 */ class As {
    ...
    next(t, e) {
        return this.Nn && D(), this.Nn = !0, this.Cn ? this.error ? this.xn(e, this.error) : this.On(t, this.result) : new As(((n, s) => {
            this.Sn = e => {
...
class Rs {
    ...
    abort(t) {
        t && this.$n.reject(t), this.aborted || (p("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Ps {
    ...
    /** Deletes the specified database. */    static delete(t) {
        return p("SimpleDb", "Removing database:", t), bs(window.indexedDB.deleteDatabase(t)).kn();
    }
     ...
     */    async zn(t) {
        return this.db || (p("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                "VersionError" === s.name ? n(new O(x.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new gs(t, s));
            }, s.onupgradeneeded = t => {
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class gs extends O {
    constructor(t, e) {
...
class Ds {
     ...
     */    cancel(t) {
        null !== this.Ts && (this.clearTimeout(), this.ws.reject(new O(x.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    Is() {
 ...
 */ function Cs(t, e) {
    if (b("AsyncQueue", `${e}: ${t}`), ys(t)) return new O(x.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
...
function _i(t, e) {
    ...
    const s = e.mutations.map((e => ns(t.Os, e))), i = z.fromMillis(e.localWriteTimeMs);
 ...
 */ class Mi {
    ...
    Ui(t) {
        return this.Bi(t).next((t => H.L(new z(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    Ki(t) {
    ...
    Oi(t, e) {
        const n = Os(e.path), s = IDBKeyRange.bound([ n ], [ G(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return $i(t).us({
 ...
 */ class ji {
     ...
     */    Fr(t) {
        if (t) {
            ...
            return e instanceof Ot && e.version.isEqual(H.min()) ? null : e;
        }
        return null;
    }
}
    ...
    di(t) {
        ...
        return this.ii.forEach(((i, r) => {
            ...
            if (r.ui) {
                ...
                const n = ci(this.Wr.Ut, new Ot(i, H.min()), this.oi(i));
...
class tr {
    ...
    u) {
        ...
        this.ao = t => Promise.resolve(), !tr.Kn()) throw new O(x.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
 ...
 */
     ...
     */    start() {
        ...
        return this.Eo().then((() => {
            ...
            throw new O(x.FAILED_PRECONDITION, Zi);
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.ho.runTransaction(t, s, ti, (s => (i = new ei(s, this.no ? this.no.next() : U.k), 
        "readwrite-primary" === e ? this.Vo(i).next((t => !!t || this.po(i))).next((e => {
            ...
            this.Xr.yo((() => this.ao(!1))), new O(x.FAILED_PRECONDITION, Ns);
            return n(i);
    ...
    Wo(t) {
        return er(t).get($s.key).next((t => {
            if (null !== t && this.No(t.leaseTimestampMs, 5e3) && !this.ko(t.ownerId) && !this.So(t) && !(this.eo || this.allowTabSynchronization && t.allowTabSynchronization)) throw new O(x.FAILED_PRECONDITION, Zi);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    bo(t) {
        const e = er(t);
        return e.get($s.key).next((t => this.So(t) ? (p("IndexedDbPersistence", "Releasing primary lease."), 
...
i) {
    ...
    return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
        ...
        return n.forEach(((n, o) => {
            ...
            // cache.
            o instanceof Ot && o.version.isEqual(H.min()) ? (
...
class pr {
    ...
    /** Compare by key then by ID */    static vc(t, e) {
        return tt.K(t.key, e.key) || W(t.Fc, e.Fc);
    }
    /** Compare by ID then by key */    static Dc(t, e) {
        return W(t.Fc, e.Fc) || tt.K(t.key, e.key);
    }
}
...
class Fr {
     ...
     */    static oa(t, e, n) {
        ...
        i && (r = new O(s.error.code, s.error.message))), i ? new Fr(t, e, s.state, r) : (b("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    ca() {
        const t = {
...
class Lr {
     ...
     */    static oa(t, e) {
        ...
        s && (i = new O(n.error.code, n.error.message))), s ? new Lr(t, n.state, i) : (b("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    ca() {
        const t = {
...
class {
            ...
            o.listenOnce(w.COMPLETE, (() => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case E.TIMEOUT:
                        p("Connection", 'RPC "' + t + '" timed out'), r(new O(x.DEADLINE_EXCEEDED, "Request time out"));
                        break;
    ...
    Du(t, e) {
        ...
        // enough the code is exception free.
            ...
            w || (w = !0, v("Connection", "WebChannel transport errored:", t), E.Au(new O(x.UNAVAILABLE, "The operation could not be completed")));
...
class Xr {
     ...
     */    Lu(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && p("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Ou} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class Zr {
     ...
     */    async close(t, e) {
        ...
        this.ju.Fu()) : e && e.code === x.UNAUTHENTICATED && 
     ...
     */    ah(t) {
        ...
        e.database = Hn(this.Ut), e.addTarget = function(t, e) {
            ...
            return n = qt(s) ? {
                ...
                query: rs(t, s)
            }, n.targetId = e.targetId, e.resumeToken.wt() > 0 ? n.resumeToken = Bn(t, e.resumeToken) : e.kt.$(H.min()) > 0 && (
...
class no extends class {} {
    ...
    Th() {
        if (this.Eh) throw new O(x.FAILED_PRECONDITION, "The client has already been terminated.");
    }
...
/** Stops listening to the query. */ async function Zo(t, e) {
    ...
    // No other queries are mapped to the target, clean up the query and the target.
        ...
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.gl.La(s.targetId), ao(n.Pl, s.targetId), uc(n, s.targetId);
        })).catch(yi);
...
function _c(t, e) {
    const n = e.key;
    t.Dl.get(n) || (p("SyncEngine", "New document in limbo: " + n), t.Sl.push(n), fc(t));
}
 ...
 */ function fc(t) {
    for (;t.Sl.length > 0 && t.Dl.size < t.yl; ) {
        ...
        t.Cl.set(n, new Ho(e)), t.Dl = t.Dl.Gt(e, n), co(t.Pl, new Re(fe(oe(e.path)), n, 2 /* LimboResolution */ , U.k));
    }
}
 ...
 */ async function Tc(t, e) {
    ...
    return n.Fl && lc(n, e.targetId, i.Tl), i;
}
...
async function Ac(t, e) {
    ...
    if (pc(n), bc(n), !0 === e && !0 !== n.Ml) {
        ...
        n.vl.forEach(((s, i) => {
            n.gl.Fa(i) ? t.push(i) : e = e.then((() => (uc(n, i), Tr(n.ph, i, 
...
function pc(t) {
    const e = N(t);
    return e.Pl.Sh.Lh = ec.bind(null, e), e.Pl.Sh.bn = Ec.bind(null, e), e.Pl.Sh.Fh = sc.bind(null, e), 
    e.pl.oh = Fo.bind(null, e.Vl), e.pl.$l = Lo.bind(null, e.Vl), e;
}

function bc(t) {
    const e = N(t);
    return e.Pl.Sh.$h = ic.bind(null, e), e.Pl.Sh.Bh = rc.bind(null, e), e;
}
 ...
 */ class Cc extends Dc {
    ...
    Ql(t) {
        const e = Hr();
        if (!Ur.Kn(e)) throw new O(x.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class Nc {
    async initialize(t, e) {
        ...
        this.Pl.Sh.e_ = wc.bind(null, this.la), await Do(this.Pl, this.la.Fl));
    }
    Zl(t) {
        return new Oo;
    }
...
class Mc {
     ...
     */    static fromBase64String(t) {
        try {
            ...
            throw new O(x.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + t);
        }
    }
    /**
 ...
 */ class Fc {
     ...
     */
    constructor(...t) {
        for (let e = 0; e < t.length; ++e) if (0 === t[e].length) throw new O(x.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.f_ = new Z(t);
    }
    /**
 ...
 * limitations under the License.
 */ function qc(t, e, n) {
    if (!n) throw new O(x.INVALID_ARGUMENT, `Function ${t}() cannot be called with an empty ${e}.`);
}
 ...
 */
function Uc(t) {
    if (!tt.lt(t)) throw new O(x.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function Kc(t) {
    if (tt.lt(t)) throw new O(x.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
e) {
    ...
    t = t.d_), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new O(x.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        {
            const n = Qc(t);
            throw new O(x.INVALID_ARGUMENT, `Expected type '${e.name}', but it was: ${n}`);
        }
    }
    return t;
}
...
function jc(t, e) {
    if (e <= 0) throw new O(x.INVALID_ARGUMENT, `Function ${t}() requires a positive number, but it was: ${e}.`);
}
...
class Gc {
    constructor(t) {
        ...
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new O(x.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        function(t, e, n, s) {
            if (!0 === e && !0 === s) throw new O(x.INVALID_ARGUMENT, `${t} and ${n} cannot be used together.`);
...
class Hc {
    ...
    constructor(t, e) {
        ...
        this.m_ = new M) : (this.A_ = t, this.I_ = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new O(x.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */ (t), this.m_ = new F(e));
     ...
     * instance.
     */    get app() {
        if (!this.A_) throw new O(x.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.A_;
    }
    get R_() {
        return this.T_;
    ...
    g_(t) {
        if (this.T_) throw new O(x.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
...
function ta(t, e, ...n) {
    ...
    {
        if (!(t instanceof Yc || t instanceof Zc)) throw new O(x.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function ea(t, e) {
    if (t = Wc(t, Hc), qc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new O(x.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Xc(t, 
    /* converter= */ null, 
    /**
...
function na(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = Q.M()), qc("doc", "path", e), t instanceof Hc) {
        const s = Y.nt(e, ...n);
 ...
 */ class ra {
     ...
     */
    constructor(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new O(x.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
...
function ya(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof z || t instanceof ra || t instanceof Mc || t instanceof Yc || t instanceof $c);
}
 ...
 */ function ba(t, e, n) {
    ...
    // FieldPath.
    e instanceof Bc && (e = e.d_), e instanceof Fc) return e.f_;
...
function Da(t, e, n, s, i) {
    ...
    a += ")"), new O(x.INVALID_ARGUMENT, c + t + a);
}
 ...
 */ class Na {
    ...
    async ef(t) {
        if (this.nf(), this.mutations.length > 0) throw new O(x.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        ...
        return e.forEach((t => {
            t instanceof Ot || t instanceof xt ? this.sf(t) : D();
        })), e;
    }
    set(t, e) {
...
class Oa {
     ...
     */
    e, n) {
        this.credentials = t, this.ls = e, this.Pu = n, this.user = P.UNAUTHENTICATED, this.clientId = Q.M(), 
     ...
     */    df() {
        if (this.ls.wf) throw new O(x.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    terminate() {
        this.ls.Ef();
        const t = new ms;
...
async function Fa(t) {
    ...
    await ka(t, new Sc)), t.mf;
}

async function La(t) {
    return t.If || (p("FirestoreClient", "Using default OnlineComponentProvider"), await Ma(t, new Nc)), 
    t.If;
}
...
function Ba(t) {
    return Fa(t).then((t => t.ph));
}

function qa(t) {
    return La(t).then((t => t.Pl));
}

function Ua(t) {
    return La(t).then((t => t.la));
}

async function Ka(t) {
    const e = await La(t), n = e.Vl;
...
/** Enables the network connection and re-enqueues all pending operations. */ function Qa(t) {
    return t.ls.enqueue((async () => {
        const e = await $a(t), n = await qa(t);
 ...
 */ function ja(t, e) {
    ...
    return t.ls.Rs((async () => async function(t, e, n) {
        try {
            ...
            s instanceof xt ? n.resolve(s) : s instanceof Ot ? n.resolve(null) : n.reject(new O(x.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
        } catch (t) {
    ...
    return t.ls.Rs((async () => function(t, e, n, s, i) {
        const r = new Oc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.Rs((() => Mo(t, o))), n.fromCache && "server" === s.source ? i.reject(new O(x.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Bo(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function ru(e, n) {
    ...
    if (void 0 !== n.cacheSizeBytes && -1 !== n.cacheSizeBytes && n.cacheSizeBytes < 1048576) throw new O(x.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return s.g_(n), s;
}
 ...
 */ function lu(t, e, n) {
    ...
    return t.ls.enqueue((async () => {
        try {
            await ka(t, n), await Ma(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function _u(t) {
    if (t.R_ && !t.P_) throw new O(x.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    const e = new ms;
...
function mu(t) {
    if (t.R_ || t.P_) throw new O(x.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ class bu {
     ...
     */    docChanges(t = {}) {
        ...
        if (e && this.ed.Ce) throw new O(x.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 * limitations under the License.
 */ function Du(t) {
    if (ae(t) && 0 === t.Ct.length) throw new O(x.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
    ...
    rd(t) {
        const e = _a(t.firestore), n = function(t, e, n, s, i, r, o) {
            ...
            return function(t, e) {
                if (e.Dt()) {
                    const n = he(t);
                    if (null !== n && !n.isEqual(e.field)) throw new O(x.INVALID_ARGUMENT, `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${e.field.toString()}'`);
                    const s = ue(t);
 ...
 * @returns The created `Query`.
 */ function Lu(t) {
    return jc("limit", t), new Fu("limit", t, "F" /* First */);
}
 ...
 * @returns The created `Query`.
 */ function $u(t) {
    return jc("limitToLast", t), new Fu("limitToLast", t, "L" /* Last */);
}
...
/** Helper function to create a bound from a document or fields */ function ju(t, e, n, s) {
    if (n[0] instanceof Bc && (n[0] = n[0].d_), n[0] instanceof Ru) return function(t, e, n, s, i) {
        ...
        // results.
            ...
            if (ht(t)) throw new O(x.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
                const t = n.field.et();
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.rt()) {
                    ...
                    if (!le(t) && -1 !== a.indexOf("/")) throw new O(x.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                    const n = t.path.child(Y.nt(a));
                    if (!tt.lt(n)) throw new O(x.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new tt(n);
                    c.push(Vt(e, i));
                } else {
                    const t = Pa(n, s, a);
...
function Gu(t, e, n) {
    if (n instanceof Bc && (n = n.d_), "string" == typeof n) {
        ...
        if (!le(e) && -1 !== n.indexOf("/")) throw new O(x.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(Y.nt(n));
        if (!tt.lt(s)) throw new O(x.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return Vt(t, new tt(s));
    }
    if (n instanceof Yc) return Vt(t, n.S_);
    throw new O(x.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Qc(n) + ".");
}
...
function Hu(t, e, n) {
    if (!n.isEqual(e)) throw new O(x.INVALID_ARGUMENT, `Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '${e.toString()}' and so you must also use '${e.toString()}' as your first argument to orderBy(), but your first orderBy() is on field '${n.toString()}' instead.`);
}
 ...
 */ class Xu {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return e instanceof Bc && (e = e.d_), r = "string" == typeof e || e instanceof Fc ? Ra(this.Id, "WriteBatch.update", i.S_, e, n, s) : Aa(this.Id, "WriteBatch.update", i.S_, e), 
    ...
    md() {
        if (this.Td) throw new O(x.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}

function Zu(t, e) {
    if (t instanceof Bc && (t = t.d_), t.firestore !== e) throw new O(x.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function ah(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e instanceof Bc && (e = e.d_), o = "string" == typeof e || e instanceof Fc ? Ra(r, "updateDoc", t.S_, e, n, s) : Aa(r, "updateDoc", t.S_, e);
...
function lh(t, ...e) {
    ...
    return function(t, e, n, s) {
        ...
        return t.ls.Rs((async () => ko(await Ka(t), r))), () => {
            i.s_(), t.ls.Rs((async () => Mo(await Ka(t), r)));
        };
    }(cu(u), h, c, a);
}
 ...
 */ class wh extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return e instanceof Bc && (e = e.d_), r = "string" == typeof e || e instanceof Fc ? Ra(this.Id, "Transaction.update", i.S_, e, n, s) : Aa(this.Id, "Transaction.update", i.S_, e), 
...
export { Mc as Bytes, su as CACHE_SIZE_UNLIMITED, Zc as CollectionReference, Yc as DocumentReference, yu as DocumentSnapshot, Fc as FieldPath, $c as FieldValue, iu as FirebaseFirestore, O as FirestoreError, ra as GeoPoint, nu as LoadBundleTask, Xc as Query, Cu as QueryConstraint, pu as QueryDocumentSnapshot, bu as QuerySnapshot, gu as SnapshotMetadata, z as Timestamp, wh as Transaction, Xu as WriteBatch, hh as addDoc, Ah as arrayRemove, mh as arrayUnion, _u as clearIndexedDbPersistence, ta as collection, ea as collectionGroup, uh as deleteDoc, Th as deleteField, wu as disableNetwork, na as doc, Lc as documentId, uu as enableIndexedDbPersistence, hu as enableMultiTabIndexedDbPersistence, du as enableNetwork, Wu as endAt, Qu as endBefore, th as getDoc, nh as getDocFromCache, sh as getDocFromServer, ih as getDocs, rh as getDocsFromCache, oh as getDocsFromServer, ou as getFirestore, Rh as increment, ru as initializeFirestore, Lu as limit, $u as limitToLast, Tu as loadBundle, Iu as namedQuery, lh as onSnapshot, _h as onSnapshotsInSync, Mu as orderBy, Nu as query, ia as queryEqual, sa as refEqual, Eh as runTransaction, Ih as serverTimestamp, ch as setDoc, y as setLogLevel, Su as snapshotEqual, Uu as startAfter, qu as startAt, Eu as terminate, ah as updateDoc, Jc as useFirestoreEmulator, fu as waitForPendingWrites, Ou as where, Ph as writeBatch };
