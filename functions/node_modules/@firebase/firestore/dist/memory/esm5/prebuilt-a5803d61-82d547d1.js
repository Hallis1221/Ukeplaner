 ...
 */ function T(t) {
    ...
    if (E.logLevel <= e.DEBUG) {
        var i = n.map(D);
        E.debug.apply(E, w([ "Firestore (8.2.6): " + t ], i));
    }
}
...
function N(t) {
    ...
    if (E.logLevel <= e.ERROR) {
        var i = n.map(D);
        E.error.apply(E, w([ "Firestore (8.2.6): " + t ], i));
    }
}
...
function A(t) {
    ...
    if (E.logLevel <= e.WARN) {
        var i = n.map(D);
        E.warn.apply(E, w([ "Firestore (8.2.6): " + t ], i));
    }
}
...
var F = function(t, e) {
    ...
    function t(t, e) {
        this.O = t, this.k = e, this.type = "FirstParty", this.user = q.P;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new G(this.O, this.k));
    }, t.prototype.v = function(t) {
...
function vt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = P(ot(t.latitude), ot(e.latitude));
            return 0 !== n ? n : P(ot(t.longitude), ot(e.longitude));
...
function yt(t, e) {
    ...
    var n = it(t), r = it(e), i = P(n.seconds, r.seconds);
 ...
 */ function ue(t) {
    var e = V(t);
    if (!e.Ft) if ("F" /* First */ === e.limitType) e.Ft = Pt(e.path, e.collectionGroup, oe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.Ft = Pt(e.path, e.collectionGroup, n, e.filters, e.limit, s, a);
    }
    return e.Ft;
}
 ...
 */ function Ue(t, e, n) {
    return t instanceof Fe ? function(t, e, n) {
        ...
        return Pe(t.jt, e) ? new Vt(t.key, Y.min()) : e;
    }(t, e);
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && C(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Ie && e instanceof Ie || t instanceof Ne && e instanceof Ne ? C(t.elements, e.elements, pt) : t instanceof De && e instanceof De ? pt(t.Ut, e.Ut) : t instanceof Ee && e instanceof Ee;
 ...
 */ var yn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, _n.$e(e, n)), new t(Y.min(), r, vn(), un(), pn());
    }, t;
}(), _n = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.Vn = function(t) {
        ...
        return this.ln = un(), this._n = An(), this.fn = new nn(P), i;
    }, 
    /**
    ...
    t.prototype.on = function(t) {
        ...
        var e = this._n.get(t);
        return e || (e = new nn(P), this._n = this._n.zt(t, e)), e;
    }, 
    /**
 ...
 */ var ir = function() {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Nn && S(), this.Nn = !0, this.xn ? this.error ? this.Fn(n, this.error) : this.On(e, this.result) : new t((function(t, i) {
            r.Dn = function(n) {
                r.On(e, n).next(t, i);
            }, r.Cn = function(e) {
                r.Fn(n, e).next(t, i);
 ...
 */
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.wc = Y.min(), this.zo = t.Qo(n), this.Ec = t.Fr(), this._o = t.Sr(), this.Tc = new br(this.Ec, this.zo, this.persistence.Ko()), 
 ...
 */ function Sr(t, e) {
     ...
     */
        ...
        u.push(Or(t, o, e.ke, r, void 0).next((function(t) {
            s = t;
        }))), !r.isEqual(Y.min())) {
 ...
 */ var Ur = /** @class */ function() {
    ...
    return t.Sc = function(t, e) {
        return J.H(t.key, e.key) || P(t.Lc, e.Lc);
    }, 
    /** Compare by ID then by key */ t.Cc = function(t, e) {
        return P(t.Lc, e.Lc) || J.H(t.key, e.key);
    }, t;
}(), qr = /** @class */ function() {
    function t(t, e) {
        this.Ei = t, this.Ti = e, 
    ...
    return t.prototype.Ai = function(t) {
        ...
        return or.resolve(0 === this.zo.length ? -1 : this.$c - 1);
        ...
        // because it precedes all other segments in an ordered traversal.
                J.wt(i) || (i = i.child(""));
        var o = new Mr(new J(i), 0), u = new nn(P);
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Hc = new xr, this.targetCount = 0, this.Jc = wr.Li();
    }
    return t.prototype.In = function(t, e) {
        ...
        return this.Hc.Oc(e), or.resolve();
    }, t.prototype.rr = function(t, e) {
        var n = this.Hc.Mc(e);
        return or.resolve(n);
    }, t.prototype.Oi = function(t, e) {
        return or.resolve(this.Hc.Oi(e));
    }, t;
}(), Gr = /** @class */ function() {
    /**
    ...
    return t.prototype.start = function() {
        ...
        return or.$n(Object.values(this.Yc).map((function(n) {
            return function() {
                return n.Oi(t, e);
            };
        })));
    ...
    function t() {
        this.iu = new Hr, this.ru = {}, this.fa = null, this.M = null;
    }
 ...
 */ var ei = /** @class */ function() {
    ...
    t.prototype.$u = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && T("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Ou + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
            ...
            return g(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Gu.Lu()) : e && e.code === U.UNAUTHENTICATED && 
    ...
    return y(e, t), e.prototype.oh = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                i = Mn(t, r.document.name), o = Cn(r.document.updateTime);
                var s = new Nt({
                    mapValue: {
            ...
            i = Mn(t, r.document), o = r.readTime ? Cn(r.readTime) : Y.min(), s = new Vt(i, o), 
            ...
            return e.targetIds && e.targetIds.length ? Y.min() : e.readTime ? Cn(e.readTime) : Y.min();
        }(t);
    ...
    e.prototype.uh = function(t) {
        ...
        e.database = Fn(this.Qt), e.addTarget = function(t, e) {
            ...
            return (n = Ut(r) ? {
                ...
                query: Qn(t, r)
            }).targetId = e.targetId, e.resumeToken.l() > 0 ? n.resumeToken = Ln(t, e.resumeToken) : e.kt._(Y.min()) > 0 && (
    ...
    e.prototype.start = function() {
        ...
        O(!!t.streamToken), this.lastStreamToken = t.streamToken, this.lh) {
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (O(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? Cn(t.updateTime) : Cn(e);
                        n.isEqual(Y.min()) && (
            ...
            }(t.writeResults, t.commitTime), n = Cn(t.commitTime);
...
function _i(t, e, n) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(u) {
            switch (u.label) {
              case 0:
                if (t.kh.set("Online" /* Online */), !(e instanceof In && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 6:
                if (e instanceof bn ? t.Mh.dn(e) : e instanceof En ? t.Mh.Pn(e) : t.Mh.Tn(e), n.isEqual(Y.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;
...
function Ii(t) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(u) {
            switch (u.label) {
              case 0:
                e = V(t), n = Li(e), r = e.Ch.length > 0 ? e.Ch[e.Ch.length - 1].batchId : -1, u.label = 1;
...
function Ti(t) {
    return yi(t) && !Li(t).zu() && t.Ch.length > 0;
}
...
function Di(t) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(o) {
            ...
            for (e = Li(t), n = 0, r = t.Ch; n < r.length; n++) i = r[n], e.fh(i.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function Oi(t, e) {
    return m(this, void 0, void 0, (function() {
        return g(this, (function(n) {
            switch (n.label) {
              case 0:
                return e && Li(t)._h ? [ 4 /*yield*/ , function(t, e) {
                    return m(this, void 0, void 0, (function() {
                        var n, r;
                        return g(this, (function(i) {
                            switch (i.label) {
    ...
    t.Uh = function(t, e, n) {
        ...
        return m(e, void 0, void 0, (function() {
            return g(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n ? (t.Uh.Yu(), vi(t) ? di(t) : t.kh.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
...
function Ri(t, e) {
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(c) {
            switch (c.label) {
              case 0:
                if (n = V(t), r = e.query, i = !1, (o = n.queries.get(r)) || (i = !0, o = new Pi), 
                !i) return [ 3 /*break*/ , 4 ];
                c.label = 1;
 ...
 */ var Fi = /** @class */ function() {
    ...
    t.prototype.yc = function(t) {
        return t.metadata.exists ? function(t, e, n) {
            var r = Mn(t, e.name), i = Cn(e.updateTime), o = new Nt({
                mapValue: {
                    fields: e.fields
                }
            });
    ...
    t.prototype.complete = function() {
        return m(this, void 0, void 0, (function() {
            ...
            return g(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return [ 4 /*yield*/ , Cr(this.bh, new zi(this.Qt), this.documents, this.il.id) ];
...
n) {
    ...
    r, i, o) {
        ...
        this.Ol = new Map, this.kl = wr.$i(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return g(this, (function(a) {
            switch (a.label) {
              case 0:
                return n = function(t) {
                    var e = V(t);
                    return e.yl.Dh.$h = eo.bind(null, e), e.yl.Dh.vn = mo.bind(null, e), e.yl.Dh.Lh = ro.bind(null, e), 
              ...
              case 2:
                return u = a.sent(), s = n.Vl.Oa(u.targetId), r = u.targetId, [ 4 /*yield*/ , Ji(n, e, r, "current" === s) ];

              case 3:
                i = a.sent(), n.Ll && fi(n.yl, u), a.label = 4;
    ...
    return m(this, void 0, void 0, (function() {
        ...
        return g(this, (function(f) {
            switch (f.label) {
                    ...
                    return function(t, e, n, r) {
                        return m(this, void 0, void 0, (function() {
                            ...
                            return g(this, (function(s) {
                                switch (s.label) {
                                  case 0:
                                    return i = e.view.fl(n), i.lc ? [ 4 /*yield*/ , Pr(t.bh, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.Ll, o), [ 2 /*return*/ , (ho(t, e.targetId, u.Il), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return i = f.sent(), o = new Yi(e, i.Rc), u = o.fl(i.documents), s = _n.$e(n, r && "Offline" /* Offline */ !== t.onlineState), 
                a = o.wi(u, 
                /* updateLimboDocuments= */ t.Ll, s), ho(t, n, a.Il), c = new Wi(e, n, o), [ 2 /*return*/ , (t.vl.set(e, c), 
        ...
        return g(this, (function(o) {
            switch (o.label) {
              case 0:
                ...
                n.Vl.Ma(r.targetId), n.Vl.Da(r.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Lr(n.bh, r.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.Vl.$a(r.targetId), hi(n.yl, r.targetId), co(n, r.targetId);
                })).catch(yr) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return co(n, r.targetId), [ 4 /*yield*/ , Lr(n.bh, r.targetId, 
 ...
 */;
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Tc.Xo(t, o).next((function(o) {
                            ...
                            var u = [], s = 0, a = e; s < a.length; s++) {
                                ...
                                // exists=true
                                u.push(new je(c.key, f, Dt(f.proto.mapValue), Le.exists(!0)));
                            }
              ...
              case 2:
                return i = s.sent(), r.Vl.Ca(i.batchId), function(t, e, n) {
                    ...
                    r || (r = new $e(P)), r = r.zt(e, n), t.Fl[t.currentUser.A()] = r;
        ...
        return g(this, (function(c) {
            switch (c.label) {
              case 0:
                ...
                /* targetMismatches= */ new nn(P), u, s), [ 4 /*yield*/ , eo(r, a) ]) : [ 3 /*break*/ , 2 ];
...
function ao(t, e, n) {
    var r = V(t), i = r.Fl[r.currentUser.A()];
...
function lo(t, e) {
    var n = e.key;
    t.Cl.get(n) || (T("SyncEngine", "New document in limbo: " + n), t.Dl.push(n), po(t));
}
 ...
 */ function po(t) {
    for (;t.Dl.length > 0 && t.Cl.size < t.pl; ) {
        ...
        t.xl.set(n, new Xi(e)), t.Cl = t.Cl.zt(e, n), fi(t.yl, new de(ue($t(e.path)), n, 2 /* LimboResolution */ , Q.q));
    }
}
            ...
            return g(this, (function(r) {
                switch (r.label) {
                  case 0:
                    ...
                    }, this.yl.Dh.n_ = yo.bind(null, this._a), [ 4 /*yield*/ , Vi(this.yl, this._a.Ll) ]);
 ...
 */ function zo(t, e) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = L.u()), Do("doc", "path", e), t instanceof xo) return Vo(n = X.ot.apply(X, w([ e ], r))), 
    new Mo(t, 
 ...
 */ function cu(t, e) {
    ...
    return function(t, e) {
        ...
        throw e.K_("Unsupported field value: " + Lo(t));
    }(t, e);
}
 ...
 */ var gu = /** @class */ function() {
                                    ...
                                    return o = a.sent(), u = new Map, o.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Mn(t, e.found.name), r = Cn(e.found.updateTime), i = new Nt({
                                                    mapValue: {
                                                ...
                                                var n = Mn(t, e.missing), r = Cn(e.readTime);
                                                return new Vt(n, r);
                                            }(t, e) : S();
                                        }(n.Qt, t);
    ...
    t.prototype.jt = function(t) {
        ...
        return !this.tf.has(t.toString()) && e ? Le.updateTime(e) : Le.Kt();
    }, 
    /**
    ...
    e, n) {
        var r = this;
        this.credentials = t, this._s = e, this.yu = n, this.user = q.UNAUTHENTICATED, this.clientId = L.u(), 
...
var Cu = /** @class */ function() {
    ...
    function e(e, n) {
        var r = this;
        return (r = t.call(this, e, n) || this).Bf = new Lu, r.w_ = "name" in e ? e.name : "[DEFAULT]", 
        r;
    }
...
function Ju(t, e, n) {
    ...
    throw new x(U.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Lo(n) + ".");
}
 ...
 */ function fs(t, e, n) {
    ...
    t = Po(t, Mo);
    var o = Po(t.firestore, Uu), u = Jo(o);
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    return e instanceof Ao && (e = e.d_), ls(o, [ ("string" == typeof e || e instanceof To ? su(u, "updateDoc", t.S_, e, n, r) : uu(u, "updateDoc", t.S_, e)).F_(t.S_, Le.exists(!0)) ]);
}
 ...
 */ function hs(t) {
    ...
    "object" != typeof i[s] || Pu(i[s]) || (u = i[s], s++);
    var a, c, f, h = {
    ...
    if (t instanceof Mo) c = Po(t.firestore, Uu), f = $t(t.S_.path), a = {
        next: function(e) {
            i[s] && i[s](ps(c, t, e));
        },
        error: i[s + 1],
 ...
 */ var ds = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        return this.Ed.push(o.F_(r.S_, Le.Kt())), this;
        ...
        this.Ed.push(o.F_(u.S_, Le.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this.md();
        var e = vs(t, this.Yf);
        return this.Ed = this.Ed.concat(new We(e.S_, Le.Kt())), this;
    }, 
    /**
...
/** Immutable class holding a blob (binary data) */ var ws = /** @class */ function(t) {
    ...
    return y(e, t), Object.defineProperty(e.prototype, "I_", {
        ...
        /** Disables the network connection. Pending operations will not complete. */ (xu(Po(this.d_, Uu)));
 ...
 */;
        ...
        try {
            return new Cs(this, function(t, e) {
                if (t = Po(t, xo), Do("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new x(U.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
                return new qo(t, 
                /* converter= */ null, 
                /**
 ...
 */ var Ns = /** @class */ function(t) {
    ...
    return y(e, t), e.prototype.get = function(t) {
        ...
        return this.d_.get(n).then((function(t) {
            return new Ls(e.Yf, new is(e.Yf.d_, e.Xf, t.S_, t.Zf, t.metadata, n.v_));
        }));
    ...
    return y(e, t), e.prototype.fromFirestore = function(t, e) {
        ...
        /* converter= */ null);
        return this.d_.fromFirestore(new Ps(this.Yf, n), null != e ? e : {});
...
var Ss = /** @class */ function(t) {
    ...
    return y(e, t), e.pd = function(t, n, r) {
        ...
        try {
            return function(t, e, n) {
                t = Po(t, Mo);
                var r = Po(t.firestore, Uu), i = es(t.v_, e, n);
                return ls(r, [ $o(Jo(r), "setDoc", t.S_, i, null !== t.v_, n).F_(t.S_, Le.Kt()) ]);
            }(this.d_, t, e);
        } catch (t) {
        ...
        return ls(Po((t = this.d_).firestore, Uu), [ new We(t.S_, Le.Kt()) ]);
        var t;
        /**
 ...
 */    }, e.prototype.onSnapshot = function() {
        ...
        var r = Vs(e), i = ks(e, (function(e) {
            return new Ls(t.firestore, new is(t.firestore.d_, t.Xf, e.S_, e.Zf, e.metadata, t.d_.v_));
        }));
        ...
        return ("cache" === (null == t ? void 0 : t.source) ? function(t) {
            t = Po(t, Mo);
            var e = Po(t.firestore, Uu), n = xu(e), r = new cs(e);
            return function(t, e) {
                var n = this, r = new ir;
                return t._s.Ps((function() {
                    return m(n, void 0, void 0, (function() {
            ...
            return new Ls(e.firestore, new is(e.firestore.d_, e.Xf, t.S_, t.Zf, t.metadata, e.d_.v_));
        }));
    }, e.prototype.withConverter = function(t) {
...
function Vs(t) {
    for (var e = 0, n = t; e < n.length; e++) {
        var r = n[e];
        if ("object" == typeof r && !Pu(r)) return r;
    }
    return {};
}
 ...
 */ function ks(t, e) {
    ...
    return {
        ...
        error: null === (n = (i = Pu(t[0]) ? t[0] : Pu(t[1]) ? t[1] : "function" == typeof t[0] ? {
            next: t[0],
            error: t[1],
            complete: t[2]
        } : {
...
var Ls = /** @class */ function(t) {
    ...
    return y(e, t), e.prototype.where = function(t, n, r) {
        ...
        try {
            return new e(this.firestore, Qu(this.d_, function(t) {
                return Co("limit", t), new Wu("limit", t, "F" /* First */);
            }(t)));
        } catch (t) {
        ...
        try {
            return new e(this.firestore, Qu(this.d_, function(t) {
                return Co("limitToLast", t), new Wu("limitToLast", t, "L" /* Last */);
            }(t)));
        } catch (t) {
    ...
    return y(e, t), Object.defineProperty(e.prototype, "type", {
        ...
        get: function() {
            return new Ps(this.Yf, this.d_.doc);
        },
        enumerable: !1,
        configurable: !0
    ...
    return y(e, t), Object.defineProperty(e.prototype, "query", {
        get: function() {
            return new Cs(this.Yf, this.d_.query);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(e.prototype, "metadata", {
    ...
    return y(e, t), Object.defineProperty(e.prototype, "id", {
        ...
        var e = this;
        return function(t, e) {
            var n = Po(t.firestore, Uu), r = zo(t), i = es(t.v_, e);
            return ls(n, [ $o(Jo(t.firestore), "addDoc", r.S_, i, null !== t.v_, {}).F_(r.S_, Le.exists(!1)) ]).then((function() {
                return r;
            }));
...
function Ms(t) {
    return t instanceof Ao && (t = t.d_), Po(t, Mo);
}
...
function zs(t) {
    ...
    }(xu(e = Po(e, Uu)), n).then((function(t) {
        return t ? new qo(e, null, t.query) : null;
    }))).then((function(t) {
        return t ? new Cs(r, t) : null;
    }));
}

export { ws as $, As as G, Ss as H, H as K, Es as Q, Ts as W, Uu as X, Ru as Y, Qo as Z, Ls as a, js as b, Fs as c, Cs as e, xs as i, Ns as j, qs as o, bs as q, Us as s, Ps as t, zs as u };
//# sourceMappingURL=prebuilt-a5803d61-82d547d1.js.map
